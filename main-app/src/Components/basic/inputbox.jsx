...
import '../../assets/css/components/inputbox.sass'

export default function Inputbox({ Class, Title, Type, Value, Name, MinLength, MinDate, MaxDate, AutoFocus, Disabled, Required, InCol, InWhite, onChange }) {
