...
import { Main, Group, Box, Inputbox, Table, Pagination, Button, Graph } from '../../Exporter/Component_Exporter'
import { useStateContext, usePageTitle, useBodyAddClass, useScreenWidth, useFetchTicketsForAI, useFetchModelPrediction, DemandForecast } from '../../Exporter/Hooks_Exporter'

export default function DemandForecastPage() {
    // Basic Hooks
    const { user } = useStateContext()
    usePageTitle(`Metro 7 | Demand Forecast`)
    ...
    const tbhead = 
        screenwidth > 766 ? {
            ...
            date: `DATE`,
            yhat: `PREDICTION`,
            yhat_upper: `HIGHEST PREDICTION`,
            yhat_lower: `LOWEST PREDICTION`,
        }
        :
        {
            item: `ITEM`,
