    ...
    return (
        <>
            ...
            <Modal Modal="EditModal-Product">
                <Form Title="MODIFY MENU" FormThreelayers OnSubmit={handleUpdateProduct} >
                    { ProductError && <Group Class="signalside"><p class="error">{ ProductError }</p></Group> ||
                    ProductSuccess && <Group Class="signalside"><p class="success">{ ProductSuccess }</p></Group> }
                    <Group Class="imageside">
                        {formData.image_url && (
            ...
            <Modal Modal="DeleteModal-Product">
                <Form Title="DELETE EMPLOYEE" FormThreelayers OnSubmit={deleteProduct}>
                    <Group Class="outputfetch" Wrap>
                        <Outputfetch Title="Product ID" Value={formData.category_id} OutCol OutWhite />
                        <Outputfetch Title="Product Name" Value={formData.product_name} OutCol OutWhite />
