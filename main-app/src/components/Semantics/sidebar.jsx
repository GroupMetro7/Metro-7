...
export default function SideBar({ ServiceMode, AdminMode, Out }) {
    return(
                ...
                <nav>
                    { ServiceMode ?
                        <>
                            ...
                            <Href Title={ <span>Logout</span> } Icon={ LogoutLogo } Logout Onclick={ Out }></Href>
                        </>
                    : undefined
                    }
                    { AdminMode ?
                        <>
                            ...
                            <Href Title={ <span>Logout</span> } Icon={ LogoutLogo } Logout Onclick={ Out }/>
                        </>
                    : undefined
                    }
                </nav>
