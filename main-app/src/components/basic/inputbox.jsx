...
export default function Inputbox({ ID, Class, Title, NoTitle, Type, Value, Name, MinLength, MinDate, MaxDate, AutoFocus, Disabled, Required, InCol, InWhite, onChange, accept, Placeholder }) {
