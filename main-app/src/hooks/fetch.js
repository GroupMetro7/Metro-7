...
useEffect(() => {
    axiosClient.get('/products') // or your correct endpoint
        .then(res => {
    ...
    return { monthlyRevenue, mostSoldProduct, loading, error, orders, setOrders, menuProduct, setMenu, categories, setCategories, ingredients, setIngredients, currentPage, setCurrentPage, totalPages, setTotalPages };
};
